...
function! moonfly#Style() abort
  ...
  if g:moonflyTerminalColors
    let g:terminal_ansi_colors = [ s:grey0, s:red, s:green, s:yellow,s:blue, s:violet, s:turquoise, s:white,s:grey58, s:crimson, s:emerald, s:khaki, s:sky, s:purple, s:lime, s:grey89]
  endif
  " Background and text
  ...
  exec 'highlight StatusLineVisual cterm=none guibg=' . s:grey18 . ' guifg=' . s:purple . ' gui=none'
  ...
  elseif g:moonflyWinSeparator == 1
    ...
    highlight! link goSpecialString MoonflyTurquoise
    ...
    " hl for insertchars Tab : SpecialKey
    " exec 'highlight SpecialKey guifg=#949494'
    exec 'highlight YankRegion guibg=' . s:blue0
    exec 'highlight YankRegionAlt guibg=' . s:blue1
